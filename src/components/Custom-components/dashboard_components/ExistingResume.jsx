     ...
     <div className="group relative">
      <div
        className="flex items-center relative justify-center animate-rotate-border 
                  rounded-lg h-[282px] cursor-pointer hover:shadow-lg p-0.5 hover:scale-105 hover:-translate-y-2   hover:[animation-play-state:paused] duration-500 transition-all" style={{
